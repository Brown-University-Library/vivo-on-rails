class BookCoversSampleData
  ...
  def self.get_all()
    ...
    cover.author_url = "http://localhost:3000/display/jpallen"
    ...
    cover.author_url = "http://localhost:3000/display/pandreas"
    ...
    cover.author_url = "http://localhost:3000/display/rarenber"
    ...
    cover.author_url = "http://localhost:3000/display/pbarmstr"
    ...
    cover.author_url = "http://localhost:3000/display/narpaly"
    ...
    cover.author_url = "http://localhost:3000/display/ebalk"
    ...
    cover.author_url = "http://localhost:3000/display/obartov"
    ...
    cover.author_url = "http://localhost:3000/display/abenton"
    ...
    cover.author_url = "http://localhost:3000/display/mblasing"
    ...
    cover.author_url = "http://localhost:3000/display/mblyth"
    ...
    cover.author_url = "http://localhost:3000/display/ebrainer"
    ...
    cover.author_url = "http://localhost:3000/display/lbraun"
    ...
    cover.author_id = "sb5"
    cover.author_url = "http://localhost:3000/display/sb5"
    ...
    cover.author_url = "http://localhost:3000/display/mcammett"
    ...
    cover.author_url = "http://localhost:3000/display/ccastigl"
    ...
    cover.author_url = "http://localhost:3000/display/cchanner"
    ...
    cover.author_url = "http://localhost:3000/display/rcheit"
    ...
    cover.author_url = "http://localhost:3000/display/tc69"
    ...
    cover.author_url = "http://localhost:3000/display/dchriste"
    ...
    cover.author_url = "http://localhost:3000/display/hchudaco"
    ...
    cover.author_url = "http://localhost:3000/display/wchun"
    ...
    cover.author_url = "http://localhost:3000/display/bconnors"
    ...
    cover.author_url = "http://localhost:3000/display/hjcook"
    ...
    cover.author_url = "http://localhost:3000/display/rcoover"
    ...
    cover.author_url = "http://localhost:3000/display/ed12"
    ...
    cover.author_url = "http://localhost:3000/display/ndenzey"
    ...
    cover.author_url = "http://localhost:3000/display/pfaudree"
    ...
    cover.author_url = "http://localhost:3000/display/tfield"
    ...
    cover.author_id = "lf7"
    cover.author_url = "http://localhost:3000/display/lf7"
    ...
    cover.author_url = "http://localhost:3000/display/cfrank"
    ...
    cover.author_url = "http://localhost:3000/display/hfreedth"
    ...
    cover.author_url = "http://localhost:3000/display/fgander"
    ...
    cover.author_url = "http://localhost:3000/display/lgandhi"
    ...
    cover.author_url = "http://localhost:3000/display/egartman"
    ...
    cover.author_url = "http://localhost:3000/display/vgolstei"
    ...
    cover.author_url = "http://localhost:3000/display/sgolub"
    ...
    cover.author_url = "http://localhost:3000/display/pgould"
    ...
    cover.author_url = "http://localhost:3000/display/jngreen"
    ...
    cover.author_url = "http://localhost:3000/display/eguldi"
    ...
    cover.author_url = "http://localhost:3000/display/mguterl"
    ...
    cover.author_url = "http://localhost:3000/display/mgutmann"
    ...
    cover.author_url = "http://localhost:3000/display/fhamlin"
    ...
    cover.author_url = "http://localhost:3000/display/jhanink"
    ...
    cover.author_url = "http://localhost:3000/display/oharmans"
    ...
    cover.author_url = "http://localhost:3000/display/tgharris"
    ...
    cover.author_url = "http://localhost:3000/display/khaynes"
    ...
    cover.author_url = "http://localhost:3000/display/shouston"
    ...
    cover.author_url = "http://localhost:3000/display/cimbrigl"
    ...
    cover.author_url = "http://localhost:3000/display/dcjackso"
    ...
    cover.author_url = "http://localhost:3000/display/njacobs"
    ...
    cover.author_url = "http://localhost:3000/display/dkertzer"
    ...
    cover.author_url = "http://localhost:3000/display/jkhalip"
    ...
    cover.author_url = "http://localhost:3000/display/dakim"
    ...
    cover.author_url = "http://localhost:3000/display/tkniesch"
    ...
    cover.author_url = "http://localhost:3000/display/pkramerm"
    ...
    cover.author_url = "http://localhost:3000/display/gkroumpo"
    ...
    cover.author_url = "http://localhost:3000/display/jkuzner"
    ...
    cover.author_url = "http://localhost:3000/display/jleinawe"
    ...
    cover.author_url = "http://localhost:3000/display/plieberm"
    ...
    cover.author_url = "http://localhost:3000/display/el46"
    ...
    cover.author_url = "http://localhost:3000/display/elincoln"
    ...
    cover.author_url = "http://localhost:3000/display/slubar"
    ...
    cover.author_url = "http://localhost:3000/display/clutz"
    ...
    cover.author_url = "http://localhost:3000/display/mmandel"
    ...
    cover.author_url = "http://localhost:3000/display/cm40"
    ...
    cover.author_url = "http://localhost:3000/display/fmartin1"
    ...
    cover.author_url = "http://localhost:3000/display/kam6"
    ...
    cover.author_url = "http://localhost:3000/display/kmclaugh"
    ...
    cover.author_url = "http://localhost:3000/display/rmeckel"
    ...
    cover.author_url = "http://localhost:3000/display/bmeeks"
    ...
    cover.author_url = "http://localhost:3000/display/cmontros"
    ...
    cover.author_url = "http://localhost:3000/display/omostefa"
    ...
    cover.author_url = "http://localhost:3000/display/jmmuller"
    ...
    cover.author_url = "http://localhost:3000/display/dmurphyd"
    ...
    cover.author_url = "http://localhost:3000/display/iosayimw"
    ...
    cover.author_url = "http://localhost:3000/display/kyperry"
    ...
    cover.author_url = "http://localhost:3000/display/sperry"
    ...
    cover.author_url = "http://localhost:3000/display/cpittell"
    ...
    cover.author_url = "http://localhost:3000/display/jpucci"
    ...
    cover.author_url = "http://localhost:3000/display/rrambuss"
    ...
    cover.author_url = "http://localhost:3000/display/travindr"
    ...
    cover.author_url = "http://localhost:3000/display/mredfiel"
    ...
    cover.author_url = "http://localhost:3000/display/aremensn"
    ...
    cover.author_url = "http://localhost:3000/display/mriva"
    ...
    cover.author_url = "http://localhost:3000/display/srockman"
    ...
    cover.author_url = "http://localhost:3000/display/brubenst"
    ...
    cover.author_url = "http://localhost:3000/display/mrutz"
    ...
    cover.author_url = "http://localhost:3000/display/as49"
    ...
    cover.author_url = "http://localhost:3000/display/wschille"
    ...
    cover.author_url = "http://localhost:3000/display/rcschnei"
    ...
    cover.author_url = "http://localhost:3000/display/gschultz"
    ...
    cover.author_url = "http://localhost:3000/display/lseifert"
    ...
    cover.author_url = "http://localhost:3000/display/nshibusa"
    ...
    cover.author_url = "http://localhost:3000/display/jmsteele"
    ...
    cover.author_url = "http://localhost:3000/display/jtiton"
    ...
    cover.author_url = "http://localhost:3000/display/avidler"
    ...
    cover.author_url = "http://localhost:3000/display/mviglian"
    ...
    cover.author_url = "http://localhost:3000/display/miwhite"
    ...
    cover.author_url = "http://localhost:3000/display/acw3"
    ...
    cover.author_url = "http://localhost:3000/display/szipp"
